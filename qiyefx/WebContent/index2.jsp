...
<script type="text/javascript" src="<c:url value="/vendor/bootstrap-4.3.1-dist/js/bootstrap.min.js"/>"></script>
  ...
  <body background="pics/c.JPG" style="background-size: 50%;">
    ...
    <div class="container">
       ...
       <div class="row py-5">
        <form action="security2Mgr" method="post" class="col-12 col-md-6 offset-md-3">
           <input type="hidden" name="task" value="login2"/>
   ...
   <div  class="with-padding" style="margin-top: -103px;margin-left: 250px;">
					<a href="zhuc.html">

    ...
    <div class="container-fluid">
	   <div class="row">
	      <div class="col-12 col-md-6">
	         <form action="repairMgr" method="post">
	              <input type="hidden" name="task" value="createRepair"/>
				  <div class="form-group">
				    <label>商品编号</label>
				    <input name="deviceid" class="form-control" placeholder="请输入需要商品编号">
				  </div>
			      <div class="form-group">
			        <label for="deviceName">商品名称</label><br>
			        <input name="devicename" class="form-control" placeholder="请输入需要商品名称">
			        
			      </div>				  
			      <div class="form-group">
			        <label for="repairDate">商品日期</label>
			        <input name="repairdate" class="form-control" placeholder="请输入商品日期">
			      </div>
			      <div class="form-group">
			        <label for="repairFacture">生产厂家</label>		
			        <input name="repairfacture" class="form-control" placeholder="请输入生产厂家">
			      </div>
			      <div class="form-group">
			        <label for="repairMoney">生产费用</label>		
			        <input name="repairmoney" class="form-control" placeholder="请输入生产费用">
			      </div>
			      <div class="form-group">
			        <label for="personLiable">责任人</label>		
			        <input name="personliable" class="form-control" placeholder="请输入责任人">
			      </div>
